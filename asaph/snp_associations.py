...
def snp_pair_associations(workdir, chrom, pos):
...
def parseargs():
    ...
    pop_parser = subparsers.add_parser("populations",
                                       help="Calculate association vs population labels")

    snp_parser = subparsers.add_parser("snp",
                                       help="Calculate association vs another SNP")

    snp_parser.add_argument("--chrom",
                            type=str,
                            required=True)

    snp_parser.add_argument("--pos",
                            type=int,
                            required=True)
